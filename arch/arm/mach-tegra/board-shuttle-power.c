...
static struct regulator_init_data ldo0_data 		 
	= ADJ_REGULATOR_INIT(ldo0,1250, 3350, 0, 0, NULL); // 3300 
...
static struct regulator_init_data ldo3_data 		 
	= ADJ_REGULATOR_INIT(ldo3,1250, 3350, 0, 0, NULL); // 3300 
static struct regulator_init_data ldo4_data 		 
	= ADJ_REGULATOR_INIT(ldo4,1700, 2000, 1, 0, NULL); // 1800
static struct regulator_init_data ldo5_data 		 
	= ADJ_REGULATOR_INIT(ldo5,1250, 3350, 1, 1, NULL); // 2850
static struct regulator_init_data ldo6_data 		 
	= ADJ_REGULATOR_INIT(ldo6,1250, 3350, 1, 1, NULL); // 2850  V-3V3 USB
static struct regulator_init_data ldo7_data 		 
	= ADJ_REGULATOR_INIT(ldo7,1250, 3350, 0, 0, NULL); // 3300  V-SDIO 
static struct regulator_init_data ldo8_data 		 
	= ADJ_REGULATOR_INIT(ldo8,1250, 3350, 0, 0, NULL); // 1800  V-2V8 
static struct regulator_init_data ldo9_data 		 
	= ADJ_REGULATOR_INIT(ldo9,1250, 3350, 1, 1, NULL); // 2850
...
/*static struct regulator_init_data buck_data 
	= ADJ_REGULATOR_INIT(buck,1250, 3350, 0, 0, NULL); // 3300*/
...
static void shuttle_board_suspend(int lp_state, enum suspend_stage stg)
{
	if ((lp_state == TEGRA_SUSPEND_LP1) && (stg == TEGRA_SUSPEND_BEFORE_CPU))
		tegra_console_uart_suspend();
}

static void shuttle_board_resume(int lp_state, enum resume_stage stg)
{
	if ((lp_state == TEGRA_SUSPEND_LP1) && (stg == TEGRA_RESUME_AFTER_CPU))
		tegra_console_uart_resume();
} 

static struct tegra_suspend_platform_data shuttle_suspend_data = { /*ok*/
	/*
	...
	.corereq_high	= false,
	.sysclkreq_high	= true, 
	.board_suspend = shuttle_board_suspend,
...
int __init shuttle_power_register_devices(void)
{
	...
	if (minor == 3 && !(tegra_spare_fuse(18) || tegra_spare_fuse(19)))
		shuttle_suspend_data.suspend_mode = TEGRA_SUSPEND_LP1;
	...
	tegra_init_suspend(&shuttle_suspend_data);
